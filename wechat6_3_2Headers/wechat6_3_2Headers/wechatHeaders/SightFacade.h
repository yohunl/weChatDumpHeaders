...
#import "SightTipsShakeViewControllerDelegate-Protocol.h"

@class CMMotionManager, MMObject, MMWindowController, MainFrameSightViewController, NSArray, NSDictionary, NSMutableArray, NSMutableDictionary, NSString, SightDraftMgr, UIImage;
