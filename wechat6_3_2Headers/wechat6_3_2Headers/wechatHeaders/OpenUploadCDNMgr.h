...
- (void).cxx_destruct;
- (void)onCheckAppAttachRetNotExistInSvr:(id)arg1 enableHitCheck:(_Bool)arg2;
- (void)onCheckAppAttachRetNotExistInSvr:(id)arg1;
- (void)onCheckAppAttachRet:(id)arg1 isExistInSvr:(_Bool)arg2 crc32:(unsigned int)arg3;
...
- (_Bool)CreateCurUploadEvent:(_Bool)arg1 crc32:(unsigned int)arg2;
