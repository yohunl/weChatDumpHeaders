...
#import "ChatMigrationBackupDataPushPoolDelegate-Protocol.h"
#import "ChatMigrationHeartBeatMonitorDelegate-Protocol.h"

@class ChatMigrationAnalysisMgr, ChatMigrationBackupDataPushPool, ChatMigrationHeartBeatMonitor, ChatMigrationProtocolLogic, MMTimer, NSArray, NSData, NSMutableArray, NSString;
@protocol ChatMigrationServerDataProcessMgrDelegate, OS_dispatch_queue;
