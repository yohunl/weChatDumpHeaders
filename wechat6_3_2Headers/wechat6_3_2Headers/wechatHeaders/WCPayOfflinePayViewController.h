...
@class MMUIView, MMWebImageView, NSArray, NSDictionary, NSObject, NSString, RichTextView, UIAttachmentBehavior, UIButton, UIDynamicAnimator, WCPayOfflinePayCodeView, WCPayOfflineUpdatedTipsView, WCPayPickerView, WCUIAlertView;
